...
|---|---|---:|
| [`DEEPSWE.md`](DEEPSWE.md) | 20 DeepSWE v1.1 coding tasks, 4 replicates per condition | **−27.6% pure agent time**; **−34.9% input tokens** |

The 15.75 vs 16.25 task-pass result is inside replicate noise. Read the benchmark as evidence
